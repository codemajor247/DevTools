...
public class Utils {
    ...
    public static List<Icon> getIcons() {
        ...
        icons.add(new Icon(R.drawable.dl_on, R.drawable.dl_off, IconType.Download));
        icons.add(new Icon(R.drawable.share_on, R.drawable.share_off, IconType.Share));
        icons.add(new Icon(R.drawable.clipboard_on, R.drawable.clipboard_off, IconType.Clipboard));
        icons.add(new Icon(R.drawable.sync_on, R.drawable.sync_off, IconType.Sync));
