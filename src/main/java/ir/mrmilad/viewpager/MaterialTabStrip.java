...
public class MaterialTabStrip extends View implements ViewPager.OnPageChangeListener {
    ...
    public MaterialTabStrip(final Context context) {
        this(context, null);
    }

    public MaterialTabStrip(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MaterialTabStrip(final Context context, final AttributeSet attrs, final int defStyleAttr) {
